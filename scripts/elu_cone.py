...
parser.add_argument('--steps', dest='steps', action='store', default=300000)
parser.add_argument('--visualize', dest='visualize', action='store_true', default=False)
parser.add_argument('--start_weights', dest='start_weights', action='store', default="weights/ddpg_elu.h5f")
parser.add_argument('--model', dest='model', action='store', default="weights/ddpg_elu_cone.h5f")
...
actor.add(Dense(48, init = init))
actor.add(ELU())
actor.add(Dense(32, init = init))
actor.add(ELU())
actor.add(Dense(24, init = init))
actor.add(ELU())
...
x = Dense(128, init = init)(x)
x = ELU()(x)
x = Dense(96, init = init)(x)
x = ELU()(x)
